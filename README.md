...
- **Internacionalizacion** — Formato por locale (numeros/moneda/fecha), catalogo de strings traducibles (`Tr`, plurales), layout RTL
...
| **Colecciones** | GridView (virtualizado), DataGrid (editable, ordenable), Pagination, ExpanderList (acordeon), FlipView (carrusel) |
...
| **Contenido rico** | SelectableText, HyperlinkButton, AutoSuggestBox, TokenizingTextBox (chips), PasswordBox, MarkdownView, Sparkline |
